...
struct proc
{
  ...
  int pid;              // Process ID
  uint start;           // Time of start -------------------------------------------------
  int tickets;          // Lottery tickets -----------------------------------------------
  int sp;               // Static priority -----------------------------------------------
  int rep;              // Number of times scheduled -------------------------------------
  int slep;             // Sleep time ----------------------------------------------------
  ...
  uint startTime; // When did the process start execution
  uint totTime;   // How long the process executed
  uint endTime;   // When did the process end execution
