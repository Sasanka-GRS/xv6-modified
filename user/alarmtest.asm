...
periodic()
{
  ...
  2e:	78a080e7          	jalr	1930(ra) # 7b4 <sigreturn>
}
  32:	60a2                	ld	ra,8(sp)
  34:	6402                	ld	s0,0(sp)
...
slow_handler()
{
  ...
  90:	728080e7          	jalr	1832(ra) # 7b4 <sigreturn>
}
  94:	60e2                	ld	ra,24(sp)
  96:	6442                	ld	s0,16(sp)
  98:	64a2                	ld	s1,8(sp)
...
dummy_handler()
{
  ...
  d0:	6e8080e7          	jalr	1768(ra) # 7b4 <sigreturn>
}
  d4:	60a2                	ld	ra,8(sp)
  d6:	6402                	ld	s0,0(sp)
...
test3()
{
 ...
 40c:	a0850513          	addi	a0,a0,-1528 # e10 <malloc+0x2be>
 ...
 424:	9c850513          	addi	a0,a0,-1592 # de8 <malloc+0x296>
