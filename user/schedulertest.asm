...
int main() {
  ...
  16:	324080e7          	jalr	804(ra) # 336 <fork>
      if (pid < 0)
  1a:	02054e63          	bltz	a0,56 <main+0x56>
          break;
      if (pid == 0) {
  ...
  2a:	a8b1                	j	86 <main+0x86>
          if (n < IO) {
  2c:	4791                	li	a5,4
  2e:	0097dd63          	bge	a5,s1,48 <main+0x48>
  32:	009897b7          	lui	a5,0x989
  36:	68078793          	addi	a5,a5,1664 # 989680 <base+0x988670>
            sleep(200); // IO bound processes
          } else {
            for (int i = 0; i < 10000000; i++) {}; // CPU bound process
  3a:	37fd                	addiw	a5,a5,-1
  3c:	fffd                	bnez	a5,3a <main+0x3a>
          }
  ...
  44:	2fe080e7          	jalr	766(ra) # 33e <exit>
            sleep(200); // IO bound processes
  48:	0c800513          	li	a0,200
  4c:	00000097          	auipc	ra,0x0
  50:	382080e7          	jalr	898(ra) # 3ce <sleep>
  54:	b7ed                	j	3e <main+0x3e>
#ifdef PBS
  ...
  for(;n > 0; n--) {
  56:	fc9048e3          	bgtz	s1,26 <main+0x26>
  5a:	4901                	li	s2,0
  5c:	4981                	li	s3,0
  ...
  5e:	45a9                	li	a1,10
  60:	02b9c63b          	divw	a2,s3,a1
  64:	02b945bb          	divw	a1,s2,a1
  68:	00001517          	auipc	a0,0x1
  6c:	81850513          	addi	a0,a0,-2024 # 880 <malloc+0xe4>
  70:	00000097          	auipc	ra,0x0
  74:	66e080e7          	jalr	1646(ra) # 6de <printf>
  exit(0);
  78:	4501                	li	a0,0
  7a:	00000097          	auipc	ra,0x0
  7e:	2c4080e7          	jalr	708(ra) # 33e <exit>
  for(;n > 0; n--) {
  82:	34fd                	addiw	s1,s1,-1
  84:	dce9                	beqz	s1,5e <main+0x5e>
      if(waitx(0,&wtime,&rtime) >= 0) {
  86:	fc840613          	addi	a2,s0,-56
  8a:	fcc40593          	addi	a1,s0,-52
  8e:	4501                	li	a0,0
  90:	00000097          	auipc	ra,0x0
  94:	356080e7          	jalr	854(ra) # 3e6 <waitx>
