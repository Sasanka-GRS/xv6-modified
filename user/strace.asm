...
main(int argc, char *argv[])
{
  ...
  26:	02f77263          	bgeu	a4,a5,4a <main+0x4a>
    fprintf(2, "1Usage: %s mask command\n", argv[0]);
...
//  printf("Came to user/strace.c\n");
  ...
  a8:	81c58593          	addi	a1,a1,-2020 # 8c0 <malloc+0x112>
  ac:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 460:	48450513          	addi	a0,a0,1156 # 8e0 <digits>
 464:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52c:	3b8b8b93          	addi	s7,s7,952 # 8e0 <digits>
 ...
 66c:	27090913          	addi	s2,s2,624 # 8d8 <malloc+0x12a>
        while(*s != 0){
